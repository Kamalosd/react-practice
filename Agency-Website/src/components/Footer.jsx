    ...
    <div className="py-20 bg-amber-200">
      <div className="mx-auto px-6 sm:px-12 md:px-24 lg:px-40">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-3">subscribe to our  newsletters</h3>
              <p className="text-sm ">the latest news, articles sent to your inbox weekly.</p>
              <div className="mt-4 flex flex-col md:flex-row items-center gap-2 items-start">
                 <input className="w-full px-6 py-3  border border-black outline-none rounded"  placeholder="enter your email "  type="email" />
                 <button className="px-6 py-3 bg-yellow-500 rounded  font-semibold cursor-pointer ">subscribe</button>
              </div>
            </div>
          </div>
