  ...
  return (
    <div className="w-full py-40">
      <div className="container mx-auto px-6 ">
        ...
        <p className="max-w-xl mx-auto text-2xl text-center mb-12">
          At our agency ,we take ppride in deliering impactful solutions that
          combine creativity and technology
        </p>

        <div className="mb-6 flex items-center justify-center gap-6">
          <button className="px-6 py-2.5  cursor-pointer font-semibold bg-yellow-200 rounded-full">
            contact me
          </button>
          <button className="px-6 py-2.5 cursor-pointer font-semibold bg-black rounded-full text-white">
            digital market
          </button>
        </div>
