...
import { FaApple, FaFacebook, FaGoogle, FaGoogleDrive, FaInstagram, FaLinkedin, FaMicrosoft, FaTwitter } from 'react-icons/fa'
...
const Company = () => {
  return (
    <div className='py-20 bg-white'>
     ...
     <p className='text-2xl md:text-3xl mb-16 text-center'> Trusted by leading companies</p>
